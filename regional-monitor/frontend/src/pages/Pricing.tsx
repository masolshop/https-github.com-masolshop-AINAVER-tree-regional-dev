...
const PRICING_PLANS: PricingPlan[] = [
  // 1. 솔루션 5종 무료 플랜
  {
    ...
    detail:
      '키워드 DNA · 키워드 발굴 · 지역 경쟁도 · 노출관리 자동체크 · 타지역 순위 자동체크 5종 솔루션을 무료로 사용하실 수 있습니다.',
    price: '무료',
    variant: 'free',
  },
  // 2. 노출 자동체크 무료 체험 플랜
...
const FAQ_ITEMS: { question: string; answer: string }[] = [
  ...
  {
    question: '무료 체험과 5종 무료플랜은 어떻게 다른가요?',
    answer:
      '솔루션 5종 무료플랜은 타지역서비스/타지역닷컴 등록관리 회원에게 키워드 DNA·발굴·경쟁도·노출 자동체크·타지역 순위 자동체크 5종을 무료로 제공하는 플랜입니다. 노출 자동체크 무료체험은 50개 회선을 1주일간 자동체크 기능만 무료로 체험하는 플랜입니다.',
  },
  {
      ...
      <TopBar
        title={
          <>
            ...
            네이버노출 매일 자동 체크,
            <br />
            타지역 SEO 지역 경쟁 분석 · 타지역 순위 자동체크 5종 솔루션 무료 사용!
          </>
        }
