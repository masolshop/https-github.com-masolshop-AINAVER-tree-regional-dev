...
type TabKey = 'stats' | 'analytics' | 'monitor' | 'schedule' | 'weekly-report' | 'users' | 'payments' | 'backup'
...
const TABS: { key: TabKey; label: string; icon: React.ReactNode; desc: string }[] = [
  ...
  { key: 'analytics', label: '방문자 분석', icon: <LineChart className="h-4 w-4" />, desc: 'GA4 기반 방문자/세션/유입 분석' },
...
const VALID_TABS: TabKey[] = ['stats', 'analytics', 'monitor', 'schedule', 'weekly-report', 'users', 'payments', 'backup']
